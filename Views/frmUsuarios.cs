...
namespace Views
{
    public partial class frmUsuarios : Form
    {
        ...
        private void frmUsuarios_Load(object sender, EventArgs e)
        {
            ...
            List<NivelAcceso> listanivelesaccesos = new CNivelAcceso().listar();
            ...
            List<Usuarios> listaUsuario = new CUsuarios().Listar();
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                int idusuariogenerado = new CUsuarios().Registrar(objusuarios, out mensaje);
            ...
            {
                bool resultado = new CUsuarios().Editar(objusuarios, out mensaje);
                if (resultado)
                {
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            if (Convert.ToInt32(txtid.Text) != 0)
            {
                if (MessageBox.Show("¿Esta seguro de eliminar al usuario?", "Alerta", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                {
                    ...
                    bool respuesta = new CUsuarios().Eliminar(objusuarios, out mensaje);
                    if (respuesta)
                    {
